...
(results/tripclick-tail_agent_vs_static_checkpoint.json) rather than
recomputing them -- those are single-touch frozen-test results
(configs/experimental_protocol.yaml) and must not be rerun. Only the new
no-reranker variant is computed here, on the identical query population,
mirroring scripts/12's precedent of one additional frozen-test diagnostic
touch beyond the three original RQ1-RQ3 touches.
